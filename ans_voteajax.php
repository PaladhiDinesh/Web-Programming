...
<?php 
	if($USERID != "undefined"){
		...
		if ($select_result->num_rows ==0){
			...
			$vote_ans_query ="UPDATE answers_table SET ans_votecount=".$vote." WHERE answer_id=$ans_id";	
			...
			if($vote==1){
				if ($que_vote_row['votes']==1){
					...
					$vote_update_query= "UPDATE votes_table SET votes = votes+1 WHERE user_id=$user_id and answer_id=$ans_id";
